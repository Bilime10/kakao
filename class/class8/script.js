const quotes = [
  ...
  "Education never ends, Wa tson. It is a series of lessons, with the greatestfor the last.",
];
...
startButton.addEventListener("click", () => {
  ...
  typedValueElement.addEventListener("input", inputEvnetListener);
});

function inputEvnetListener() {
  ...
  if (typedValue === currentWord && wordIndex === words.length - 1) {
    ...
    typedValueElement.removeEventListener("input", inputEvnetListener);
